...
modList.mods.forEach(mod => 
  https.get(`${prefix}${!isNumeric(mod.gitPath) ? repos : repositories}${mod.gitPath}/releases/${mod.tag ? mod.tag : postfix}`, { headers: { 'User-Agent' : 'astraldamonk/MonkeModInfo' ,'Authorization': `Token ${process.env.SECRET}`}},(res) => {
    let body = "";
